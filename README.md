...
![Gibson pedal with printed insert](Images/gibson-pedal-installed.jpg)
...
- `3D-print/STL/` — STL files for printing
- `3D-print/3MF/` — 3MF files, where available
...
This model was created as a replacement for the original plastic
